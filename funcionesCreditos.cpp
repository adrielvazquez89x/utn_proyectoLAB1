...
void mostrarCreditos(int &opcion, Jugador &j1, Jugador &j2, Jugador vEstadisticas[])
{
    ...
    int x = pantallaAncho / 2;            // Hacemos uso de las clases de matemática XD
    int y = pantallaAltura;

    string creditos = "CREDITOS";
    string alumnos = "Alumnos: ";
    string miguel = "Lardo Miguel Angel - LEGAJO: #####";
    string adriel = "Vazquez Adriel Alejandro - LEGAJO: 29930";
    string equipo = "Equipo n° 33 - Maestros de la luz y sombras. (AWANTÁ)";

    while (y >= pantallaAltura / 2)
    {
